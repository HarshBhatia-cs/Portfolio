    ...
    <section className="about-section page-section">
      <div className="container">
        ...
        <div className="about-content">
          <div
            className="about-text fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
            <p className="lead-text">
              I am a 21-year-old developer passionate about creating meaningful
              digital experiences.
            </p>
            <p className="body-text">
              Currently in my 6th semester pursuing Computer Science Engineering
              from MRIIRS, Faridabad. Technology excites me, and I am always in
              awe of the change it drives in the world around us.
            </p>
          ...
          <div
            className="about-cards fade-in-scale"
          ...
          >
            ...
            <div className="info-card glass-panel">
              ...
              <h3>Profile</h3>
              <p className="card-highlight">21 Years Old</p>
