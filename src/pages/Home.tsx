        ...
        <section className="home-section page-section">
            <div className="container home-container">
                <div className="home-content">
                    <div className="greeting fade-in-up" style={{ animationDelay: '0.1s' }}>
                    ...
                    <h2 className="hero-subtitle fade-in-up" style={{ animationDelay: '0.3s' }}>
                        Trying to make "Hello World" the new "abc"
                    </h2>

                    <p className="hero-description fade-in-up" style={{ animationDelay: '0.4s' }}>
                        I am a enthusiastic <span className="highlight">MERN Full Stack Developer</span> eager to create real-world impact through technology and modern web experiences.
                    </p>
                ...
                <div className="home-visual fade-in-scale" style={{ animationDelay: '0.3s' }}>
                    ...
                    <div className="glass-card main-card">
                        ...
                        <pre className="code-content">
                            <code>
                                ...
                                <br />
                                {'  '}stack: [<span className="string">'MongoDB'</span>, <span className="string">'Express'</span>, <span className="string">'React'</span>, <span className="string">'Node.js'</span>],
                                <br />
                                {'  '}passion: <span className="string">'Real-world impact'</span>
                                <br />
                                {'}'};
                            </code>
                        </pre>
